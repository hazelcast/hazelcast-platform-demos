...
/**
 * <p>
 * A clone of {@link JetToPythonServer} for use by a DAG.
 * </p>
 */
class DagJetToPythonServer {
    ...
    DagJetToPythonServer(@Nonnull Path baseDir, @Nonnull ILogger logger) {
    ...
    int start() throws IOException {
        try (ServerSocket serverSocket = new ServerSocket()) {
            ...
            pythonProcessPid = DagPythonServiceContext.processPid(pythonProcess);
