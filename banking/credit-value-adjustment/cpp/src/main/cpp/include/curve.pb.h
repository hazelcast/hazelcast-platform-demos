...
class Curve PROTOBUF_FINAL :
 ...
 public:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_calendar();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_calendar(
      std::string* calendar);
  private:
  ...
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_dcc();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_dcc(
      std::string* dcc);
  private:
...
inline std::string* Curve::unsafe_arena_release_curvename() {
  // @@protoc_insertion_point(field_unsafe_arena_release:FlumaionQL.Curve.curvename)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return curvename_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Curve::unsafe_arena_set_allocated_curvename(
    std::string* curvename) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (curvename != nullptr) {
  ...
  curvename_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      curvename, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:FlumaionQL.Curve.curvename)
}
...
inline std::string* Curve::unsafe_arena_release_index() {
  // @@protoc_insertion_point(field_unsafe_arena_release:FlumaionQL.Curve.index)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return index_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Curve::unsafe_arena_set_allocated_index(
    std::string* index) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (index != nullptr) {
  ...
  index_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      index, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:FlumaionQL.Curve.index)
}
...
inline void Curve::_internal_set_calendar(const std::string& value) {
  ...
  calendar_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void Curve::set_calendar(const char* value) {
  ...
  calendar_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void Curve::set_calendar(const char* value,
  ...
  calendar_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:FlumaionQL.Curve.calendar)
}
inline std::string* Curve::_internal_mutable_calendar() {
  
  return calendar_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Curve::release_calendar() {
  // @@protoc_insertion_point(field_release:FlumaionQL.Curve.calendar)
  return calendar_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline std::string* Curve::unsafe_arena_release_calendar() {
  // @@protoc_insertion_point(field_unsafe_arena_release:FlumaionQL.Curve.calendar)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return calendar_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Curve::unsafe_arena_set_allocated_calendar(
    std::string* calendar) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (calendar != nullptr) {
  ...
  calendar_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      calendar, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:FlumaionQL.Curve.calendar)
}
...
inline void Curve::_internal_set_dcc(const std::string& value) {
  ...
  dcc_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void Curve::set_dcc(const char* value) {
  ...
  dcc_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void Curve::set_dcc(const char* value,
  ...
  dcc_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:FlumaionQL.Curve.dcc)
}
inline std::string* Curve::_internal_mutable_dcc() {
  
  return dcc_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Curve::release_dcc() {
  // @@protoc_insertion_point(field_release:FlumaionQL.Curve.dcc)
  return dcc_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Curve::set_allocated_dcc(std::string* dcc) {
  ...
  dcc_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), dcc,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:FlumaionQL.Curve.dcc)
}
inline std::string* Curve::unsafe_arena_release_dcc() {
  // @@protoc_insertion_point(field_unsafe_arena_release:FlumaionQL.Curve.dcc)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return dcc_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void Curve::unsafe_arena_set_allocated_dcc(
    std::string* dcc) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (dcc != nullptr) {
  ...
  dcc_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      dcc, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:FlumaionQL.Curve.dcc)
}
