...
CMD="docker run -e MY_INITSIZE=1 -e MY_KUBERNETES_ENABLED=false -e MY_PARTITIONS=271 -e JAVA_ARGS=-Dhazelcast.local.publicAddress=${HOST_IP} -p 5701:5701 --network=${PROJECT} ${DOCKER_IMAGE}"
#echo $CMD
