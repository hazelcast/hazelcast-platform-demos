...
echo use $FLAVOR\; >> $FILENAME
echo db.createUser\( >> $FILENAME
echo \{ user: \'@my.other.admin.user@\', >> $FILENAME  
echo pwd: \'@my.other.admin.password@\', >> $FILENAME  
echo roles: \[ \{ role: \"readWrite\", db: \"admin\" \}, \{ role: \"readWrite\", db: \"$FLAVOR\" \}, \{ role: \"readWrite\", db: \"config\" \}, \{ role: \"readWrite\", db: \"local\" \}, \{ role: \"readWrite\", db: \"listCollections\" \}, \{ role: \"readWrite\", db: \"listDatabases\" \} \] >> $FILENAME
echo \} \) >> $FILENAME
...
then
 ...
 echo \$HOSTNAME is \'$HOSTNAME\' not \'mongo\'
 echo \$HOSTNAME is \'$HOSTNAME\' not \'mongo\' : Docker not Kubernetes\?
 echo \$HOSTNAME is \'$HOSTNAME\' not \'mongo\'
 echo \$HOSTNAME is \'$HOSTNAME\' not \'mongo\'
 echo "$0: = = = = = = = = = = = = = = = = = = = = = = = = = = = ="
fi